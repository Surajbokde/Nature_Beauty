                    ...
                    <div class="col-lg-12 posts-list">
                        <div class="single-post row">
                            ...
                            <div class="col-lg-12 col-md-12 blog_details">
                                <h2>8 Reasons Why You Should Plant a Tree For Earth Day</h2>
                                <p class="excert">
                                ...
                                <p>
                                    Trees improve air quality by producing oxygen. They also store carbon, offsetting harmful byproducts of fossil-fuel burning.<br>
They moderate the effects of sun and wind, and they clean the air by trapping dust, pollen and other pollutants. <br>
Planted in the right places around buildings, trees can significantly reduce air-conditioning costs. This means less Freon, an inflammable and odorless chemical emitted from air conditioners. It is considered to have damaging effects to the ozone layer.
                        ...
                        <div class="comment-form">
                            <h4>Do you have a good blog idea? Get in touch</h4>
                            <form>
                                <div class="form-group form-inline">
                                  <div class="form-group col-lg-6 col-md-6 name">
                                    <input type="text" class="form-control" id="name" placeholder="Enter Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="title" placeholder="Enter title of blog" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter title of blog'">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control mb-10" rows="5" name="blogpost" placeholder="blog_area" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Write your blog'" required="" style="overflow:scroll;"></textarea>
                                </div>
                                <a href="#" class="primary-btn submit_btn">Submit your idea</a>	
                            </form>
                        </div>
                    </div>
