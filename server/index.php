                ...
                <div class="row">
                    <div class="col-md-8 col-lg-7">
                        <div class="xs-volunteer-form-wraper bg-aqua">
                            ...
                            <form action="#" method="POST" id="volunteer-form" class="xs-volunteer-form" name="volunteerForm">
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <textarea name="massage" id="massage" name="volunteerMsg"  placeholder="Enter your message" cols="30" class="form-control" rows="10"></textarea><small></small>
